...
Kami is an open source project by [Tw93](https://tw93.fun) with 8.1K GitHub stars. Kami is a document design system that produces beautifully typeset PDFs. It uses a warm parchment aesthetic with ink-blue accents, serif-led hierarchy, and tight editorial spacing. Supports both Chinese and English typography.

Latest release: V1.7.2 (2026-06-13)
