...
Kami is an open source project by [Tw93](https://tw93.fun) with 6.7K GitHub stars. Kami is a document design system that produces beautifully typeset PDFs. It uses a warm parchment aesthetic with ink-blue accents, serif-led hierarchy, and tight editorial spacing. Supports both Chinese and English typography.

Latest release: V1.6.0 (2026-05-29)
...
Resumes, one-pagers, white papers, letters, portfolios, and slide decks. It handles both Chinese and English with appropriate typefaces.

**How does Kami work with Claude Code?**

Kami is invoked via the /kami slash command in Claude Code (installed through Waza). You describe what you want, and it generates a typeset HTML document that can be exported to PDF, image, or slide deck.
